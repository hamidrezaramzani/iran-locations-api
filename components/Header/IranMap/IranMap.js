...
export const IranMap = ({ domain }) => {
  ...
  const handleCopyStateInformation = () => {
    navigator.clipboard.writeText(
      `${domain}/api/v1/${language}/states?state=${currentState}`
    );
    setAlertOpen(true);
  };

  const handleCopyCitiesOfStateInformation = () => {
    navigator.clipboard.writeText(
      `${domain}/api/v1/${language}/cities?state=${currentState}`
    );
    setAlertOpen(true);
  };
  ...
  return (
    ...
    >
      ...
      <Dialog open={isOpen} onClose={() => setIsOpen(false)}>
        <DialogTitle id="alert-dialog-title" className="iran-yekan-bold">
          دریافت اطلاعات استان {currentState}
        </DialogTitle>
        <DialogContent>
          <Box
            display="flex"
          ...
          >
            <FormControl>
              <FormLabel className="iran-yekan">زبان داده های ارسالی</FormLabel>
              <RadioGroup
            ...
            <Button
              color="success"
              variant="outlined"
              onClick={() => handleCopyStateInformation()}
              className="iran-yekan"
            >
              دریافت آدرس مربوط به اطلاعات استان {currentState}
            </Button>

            <Button
              color="success"
              onClick={() => handleCopyCitiesOfStateInformation()}
              variant="outlined"
              className="iran-yekan"
            >
              دریافت آدرس مربوط به شهر های استان {currentState}
            </Button>
          </Box>
        </DialogContent>
        <DialogActions>
      ...
      >
        ...
        <Tooltip
          className="iran-yekan"
          title={t("common:states.sistanBaluchestan")}
        >
          <path
        ...
        <Tooltip
          className="iran-yekan"
          title={t("common:states.khorasanShomali")}
        >
          <path
        ...
        <Tooltip
          className="iran-yekan"
          title={t("common:states.khorasanRazavi")}
        >
          <path
        ...
        <Tooltip
          className="iran-yekan"
          title={t("common:states.khorasanJonoubi")}
        >
          <path
        ...
        <Tooltip
          className="iran-yekan"
          title={t("common:states.kordestan")}
        >
          <path
        ...
        <Tooltip
          className="iran-yekan"
          title={t("common:states.kermanshah")}
        >
          <path
        ...
        <Tooltip className="iran-yekan" title="آذربایجان شرقی">
          <path
        ...
        <Tooltip className="iran-yekan" title="آذربایجان غربی">
          <path
        ...
        <Tooltip className="iran-yekan" title="قزوین">
          <path
        ...
        <Tooltip className="iran-yekan" title="زنجان">
          <path
        ...
        <Tooltip className="iran-yekan" title="همدان">
          <path
        ...
        <Tooltip className="iran-yekan" title="فم">
          <path
        ...
        <Tooltip className="iran-yekan" title="مرکزی">
          <path
        ...
        <Tooltip className="iran-yekan" title="اردبیل">
          <path
        ...
        <Tooltip className="iran-yekan" title="هرمزگان">
          <path
        ...
        <Tooltip className="iran-yekan" title="ایلام">
          <path
        ...
        <Tooltip className="iran-yekan" title="لرستان">
          <path
        ...
        <Tooltip className="iran-yekan" title="خوزستان">
          <path
        ...
        <Tooltip className="iran-yekan" title="چهارمحال بختیاری">
          <path
        ...
        <Tooltip className="iran-yekan" title="یزد">
          <path
        ...
        <Tooltip className="iran-yekan" title="تهران">
          <path
        ...
        <Tooltip className="iran-yekan" title="سمنان">
          <path
        ...
        <Tooltip className="iran-yekan" title="مازندران">
          <path
        ...
        <Tooltip className="iran-yekan" title="گلستان">
          <path
        ...
        <Tooltip className="iran-yekan" title="فارس">
          <path
        ...
        <Tooltip className="iran-yekan" title="اصفهان">
          <path
        ...
        <Tooltip className="iran-yekan" title="بوشهر">
          <path
        ...
        <Tooltip className="iran-yekan" title="كهكيلويه و بويراحمد">
          <path
